Code to solve the Advent of code puzzles for the 2025 edition. Every folder has 2 files, with code to solve the first part and second part of that day's challenge.

**How to use it:**
---
- Add a file in each folder called 'Input.txt' Add your puzzle input here.
- In the command line, enter the correct folder. E.G. 'cd Day02'
